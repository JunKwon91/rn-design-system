...
// 컨테이너: height 44, borderRadius 22 (pillbox), 1px border.default,
...
//   height 44 (외곽 height와 동일, border 영역 침범)
//   left + width useSharedValue (200ms timing, Easing.inOut(Easing.ease))
//   bg primary.action
// 각 세그먼트: flex 1, height 44, margin-vertical -1 (border 침범 패턴)
//             세그먼트는 항상 탭 대상이라 최소 터치 44를 시각 높이로 채운다(ADR-50).
